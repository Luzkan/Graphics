...
var drawBufferFace= function ( gl, rotation, move, projection, buffer, textureId, textureUnit, filterType ) {
    /* Parameters:
       gl - WebGL context
...
var createTexture2D= function(gl, filterType, useMipmap){
    /* parameters:
       gl -  WebGL contex
    ...
    */
    ...
    console.log("Source for Image: ", image)
...
var boxFaceTextures=[];
var useFilterNearest = false;
var useMipmap = false;

var redraw=function(wantFilter){
    ...
    var filterType;
    (wantFilter) ? console.log("Current Filter: Nereast") : console.log("Current Filter: Linear");
    (wantFilter) ? filterType = gl.NEAREST : filterType = gl.LINEAR;
    ...
    drawBufferFace( gl, rotationMatrix, moveVector, projectionMatrix, 
			   xPlusArrayBuffer,  boxFaceTextures[0] , 1, filterType ) 
    drawBufferFace( gl, rotationMatrix, moveVector, projectionMatrix, 
			   xMinusArrayBuffer,  boxFaceTextures[1] , 2, filterType ) 

    drawBufferFace( gl, rotationMatrix, moveVector, projectionMatrix, 
			   yPlusArrayBuffer,  boxFaceTextures[2] , 3, filterType ) 
    drawBufferFace( gl, rotationMatrix, moveVector, projectionMatrix, 
			   yMinusArrayBuffer,  boxFaceTextures[3] , 4, filterType ) 

    drawBufferFace( gl, rotationMatrix, moveVector, projectionMatrix, 
			   zPlusArrayBuffer,  boxFaceTextures[4] , 5, filterType ) 
    drawBufferFace( gl, rotationMatrix, moveVector, projectionMatrix, 
			   zMinusArrayBuffer,  boxFaceTextures[5] , 6, filterType ) 
...
function onKeyDown(e){
	...
	break;
    case 66: // B
    console.log("Switching Filter Type!");
    useFilterNearest = (useFilterNearest === true) ? false : true;
    break;
    case 78: // N
    console.log("Switching Mipmap Usage to: ", !useMipmap);
    useMipmap = (useMipmap === true) ? false : true;
    restartField(useMipmap);
    break;
    case 86: // V
	moveVector[2]--;
	break;
...
function restartField(useMipmap){
    html={};
	...
	boxFaceTextures.push( createTexture2D(gl, gl.NEAREST, useMipmap) );
    }
...
window.onload= function(){
	...
	sbx_fillCanvasUpsideDown( canvasTex, sbx_createFunctionRGB( fun[r], fun[g], fun[b], skyboxXYZ[skyboxStep] ) );
	sbx_loadCubeFaceFromCanvas(gl, canvasTex, cubeFace[skyboxStep]);
	boxFaceTextures.push( createTexture2D(gl, gl.NEAREST, false) );
    }
